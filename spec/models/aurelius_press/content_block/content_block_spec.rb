...
RSpec.describe AureliusPress::ContentBlock::ContentBlock, type: :model do
  subject { build(:aurelius_press_content_block_content_block, :as_rich_text_block, :on_a_blog_post) }
